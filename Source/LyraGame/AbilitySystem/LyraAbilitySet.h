...
public:
	...
	// Same as above, but abilities whose class matches (or derives from) one in ExcludedAbilities are skipped.
	// SlimeFable morph bodies use this to take the ShooterCore hero set without GA_Hero_Death.
	UE_API void GiveToAbilitySystemFiltered(ULyraAbilitySystemComponent* LyraASC, FLyraAbilitySet_GrantedHandles* OutGrantedHandles, UObject* SourceObject, const TArray<TSubclassOf<ULyraGameplayAbility>>& ExcludedAbilities) const;
