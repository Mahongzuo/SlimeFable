...
{
	// Unloaded = never started (SlimeFable play maps). Do not keep a forever loading screen.
	if (LoadState == ELyraExperienceLoadState::Unloaded || LoadState == ELyraExperienceLoadState::Loaded)
	{
		return false;
	}
