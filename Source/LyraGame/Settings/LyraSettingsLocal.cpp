...
ULyraSettingsLocal* ULyraSettingsLocal::Get()
{
	...
	if (ULyraSettingsLocal* Settings = Cast<ULyraSettingsLocal>(GEngine->GetGameUserSettings()))
	{
		return Settings;
	}

	UE_LOG(LogLyra, Error, TEXT("GameUserSettings is not LyraSettingsLocal. Set GameUserSettingsClassName=/Script/LyraGame.LyraSettingsLocal in DefaultEngine.ini."));
	return nullptr;
}
